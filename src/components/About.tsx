  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center mt-80 space-y-100">
          <p className="text-sm text-gray-400 dark:text-gray-400">
            MANKARAY INDUSTRIES PRIVATE LIMITED
          </p>
          <p className="text-xs lg:text-sm text-gray-200 dark:text-gray-50 text-center">
